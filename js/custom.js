...
$('body').on('click', '.updatePricingEdit', function(){
  ...
  $.ajax({
    ...
    success: function(response){
        ...
        htmlDiv.html(`<input class="partQuantityUpdate" type="text" val="" /><span><i class="fa-plus"></i><i class="fa-minus"></i></span><a class="button" href="#" style="display: inline-block;">Update cart</a><span class="close">Close</span>`);
          ...
          $.ajax({
            ...
            $.ajax({
                ...
                success: function(updateResponse){
                    ...
                    $('.widget_shopping_cart_content').html(updateResponse);
                    $('.nectar-slide-in-cart.open, .woocommerce-cart-form__cart-item').removeClass('ajaxLoading');
                }
            });
